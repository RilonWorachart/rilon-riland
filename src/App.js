  ...
  return (
    <>
      <div className="min-h-screen">
        ...
        <div className="px-[100px] py-2 aligns-center justify-center ">
          <div className="py-1">
          ...
          <div className="py-1">
            110/61,91/1 ตำบลไทรม้า อำเภอเมืองนนทบุรี นนทบุรี 11000
          </div>
          <div>
        ...
        <div className="px-[100px] text-center bg-[#152431] py-8">
          ...
          <div>
            <div className="text-[#E2B22C] backdrop-blur-sm bg-white/10 pt-1 pb-4 px-[20px]">
              ...
              <p className="text-[22px] text-[#F4D016]">
        ...
        <div className=" py-4 text-center px-[100px]">
          <img></img>
          <hr />
          <h1 className="py-2 text-[24px]">
          ...
          <div className="py-4">
            <p className="text-[#FF0042] text-[20px]">สนใจติดต่อสอบถามเพิ่มเติม สแกนเลย</p>
            <img></img>
            <p className="text-[#FF0042] text-[20px]">คลิกเพิ่มเพื่อน</p>
            <img></img>
          </div>
        </div>


        <div className="px-[100px] py-12 bg-[#FFD600] flex ">
          <div className="w-[50%]">
            <h1 className="py-4 text-[30px] text-center">
              ศูนย์จัดจำหน่าย
