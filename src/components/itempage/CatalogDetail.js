...
function CatalogDetail() {
    ...
    return (
        <>
            ...
            <div className="mx-[80px] my-[30px] px-[15px] py-[15px] border-[1px] border-lightgray rounded-md">
                <img className=" w-[100%] md:w-[50%] border  rounded-md" src={`/images/products/${productData.image}`} alt={productData.name} />
