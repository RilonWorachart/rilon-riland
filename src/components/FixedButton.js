        ...
        <div>
            ...
            <div className="">
                ...
                <a href="https://page.line.me/156vctty?openQrModal=true"
                    className={`z-20 fixed left-[20px] h-[35px] w-[35px] bg-[#E2B22C] text-white flex items-center justify-center rounded-full shadow-xl hover:bg-white hover:text-[#42189F] hover:border hover:border-[#42189F] transition-all duration-300 ${isContactActive ? 'bottom-[115px]' : 'bottom-[65px]'}`}
                >
                    <FaLine />
                </a>
                <a href="https://www.facebook.com/profile.php?id=61555700229121"
                    className={`z-20 fixed left-[20px] h-[35px] w-[35px] bg-[#E2B22C] text-white flex items-center justify-center rounded-full shadow-xl hover:bg-white hover:text-[#42189F] hover:border hover:border-[#42189F] transition-all duration-300 ${isContactActive ? 'bottom-[165px]' : 'bottom-[65px]'}`}
                >
                    <FaFacebookSquare className="" />
                </a>
                <a href="mailto:janenyrilon_jingwei@hotmail.com"
                    className={`z-20 fixed left-[20px] h-[35px] w-[35px] bg-[#E2B22C] text-white flex items-center justify-center rounded-full shadow-xl hover:bg-white hover:text-[#42189F] hover:border hover:border-[#42189F] transition-all duration-300 ${isContactActive ? 'bottom-[215px]' : 'bottom-[65px]'}`}
                >
            ...
            <div className="">
                ...
                <a href="https://page.line.me/156vctty?openQrModal=true"
                    className={`z-20 fixed bottom-[15px] h-[35px] w-[35px] bg-[#E2B22C] text-white flex items-center justify-center rounded-xl shadow-xl hover:bg-white hover:text-[#42189F] hover:border hover:border-[#42189F] transition-all duration-300 ${isSocialActive ? 'left-[70px]' : 'left-[20px]'}`}
                >
                    <FaLine />
                </a>
                <a href="https://www.facebook.com/profile.php?id=61555700229121"
                    className={`z-20 fixed bottom-[15px] h-[35px] w-[35px] bg-[#E2B22C] text-white flex items-center justify-center rounded-xl shadow-xl hover:bg-white hover:text-[#42189F] hover:border hover:border-[#42189F] transition-all duration-300 ${isSocialActive ? 'left-[120px]' : 'left-[20px]'}`}
                >
                    <FaFacebookSquare className="" />
                </a>
                <a href="https://www.instagram.com/rilon_thailand/"
                    className={`z-20 fixed bottom-[15px] h-[35px] w-[35px] bg-[#E2B22C] text-white flex items-center justify-center rounded-xl shadow-xl hover:bg-white hover:text-[#42189F] hover:border hover:border-[#42189F] transition-all duration-300 ${isSocialActive ? 'left-[170px]' : 'left-[20px]'}`}
                >
                    <FaInstagram className="" />
                </a>
                <a href="https://www.youtube.com/@rilon_thailand"
                    className={`z-20 fixed bottom-[15px] h-[35px] w-[35px] bg-[#E2B22C] text-white flex items-center justify-center rounded-xl shadow-xl hover:bg-white hover:text-[#42189F] hover:border hover:border-[#42189F] transition-all duration-300 ${isSocialActive ? 'left-[220px]' : 'left-[20px]'}`}
                >
                    <FaYoutube className="" />
                </a>
                <a href="mailto:janenyrilon_jingwei@hotmail.com"
